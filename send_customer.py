...
if __name__ == "__main__":
  ...
  if not user_id in serv.get_user_id_list():
    ...
    repo.update_users(user_id, "email", "kirinsannnnn@gmail.com")
    repo.update_users(user_id, "phone", "09092786186")
    repo.update_users(user_id, "sir_name", "土沢")
    repo.update_users(user_id, "first_name", "誉太")
